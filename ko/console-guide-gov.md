...
## 복원 신청
등록한 백업 계획이 1회 이상 수행되었다면, 백업 결과에 데이터로 복원할 수 있습니다.
...
데이터를 저장할 서버는 백업 에이전트로 등록한 서버 중 선택할 수 있습니다.

<br/>

* **저장 경로**

복원 저장 경로는 지정할 수 있으며 입력한 경로가 존재하지 않을 경우 자동으로 경로를 생성하여 복원이 진행됩니다.
입력한 경로에 동일한 데이터가 있는 경우 덮어쓰기 방식으로 진행됩니다.
